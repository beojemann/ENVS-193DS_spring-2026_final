...
# model 1: effect of tree height and ant species on nest presence w/ interaction term
model1 <- glm(
...
# model 2: interaction between tree height and ant species on nest presence w/o interaction term
model2 <- glm(
